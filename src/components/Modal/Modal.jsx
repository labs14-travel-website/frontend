...
/**
 * @description Displays a modal that pulls individual place and attraction data from the API. Includes price and rating
 * indicators, along with the place name, a description, and a photo. Also includes a button to close the modal.
